...
<%@ page import="com.mo.crm.domain.Tran" %>
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" <%--value="${t.id}"--%> onclick="window.location.href='workbench/transaction/edit.do?id=${t.id}';"><span class="glyphicon glyphicon-edit"></span> 编辑</button>
	...
	<div style="position: relative; top: 0px;">
		<input type="hidden" value="${t.id}" id="transaction-id">

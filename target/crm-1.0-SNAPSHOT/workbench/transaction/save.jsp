...
<body>
	...
	<div style="position:  relative; left: 30px;">
		<h3>创建交易</h3>
	  	<div style="position: relative; top: -40px; left: 70%;">
		    ...
		    <button type="button" id="quxiao" onclick="location.href='javascript:history.go(-1);'" class="btn btn-default">取消1</button>
			<button type="button" id="quxiao1" onclick="location.href='javascript:history.back(-1);'" class="btn btn-default">取消2</button>
			<button type="button" onclick="location.href='javascript:history.back();'" class="btn btn-default">取消3</button>
		</div>
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" readonly placeholder="点击选择时间" class="form-control time1" id="create-expectedClosingDate" name="expectedDate">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="e4f1ab0c389441df8e195376c5e9269f"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="dff02df9a9544dc8a4dd2f00eaa65254"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" readonly placeholder="点击选择时间" class="form-control time2" id="create-nextContactTime" name="nextContactTime">
			</div>
		</div>

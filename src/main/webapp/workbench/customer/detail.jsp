...
<script type="text/javascript">
			...
			success : function (data) {
				...
				if (data) {
					...
					$.each(data,function (i,n) {
						...
						html+='<font color="gray">联系人</font> <font color="gray">-</font> <b>${customer.owner}-${customer.name}</b> <small style="color: gray;">'+(n.editFlag==0?n.createTime:n.editTime)+'由'+(n.editFlag==0?n.createBy:n.editBy)+'</small>';
	...
	function searchTransaction() {
		...
		$.ajax({
			url : "workbench/customer/searchTransaction.do",
			data: {
				"customerId":"${customer.id}"
			},
			type : "get",
...
<body>
    ...
    <div class="modal-dialog" role="document" style="width: 40%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <button type="button" class="btn btn-primary" id="updateRemarkBtn">更新customer</button>
            </div>
        </div>
    </div>
    </div>
    ...
    <div class="modal fade" id="editCustomerModal" role="dialog">
        <div class="modal-dialog" role="document" style="width: 85%;">
            <div class="modal-content">
                      ...
                      <input type="hidden" id="edit-id" >
                        ...
                        <div style="position: relative;top: 15px;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10" style="width: 300px;">
                                    <input type="text" readonly placeholder="点击修改下次联系时间" class="form-control time" id="edit-nextContactTime">
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    <button type="button" class="btn btn-primary" id="updateBtn">更新1</button>
                </div>
            </div>
        </div>
    </div>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" data-toggle="modal" id="editBtn"><span class="glyphicon glyphicon-edit"></span> 编辑1</button>
			<button type="button" id="deleteBtn" class="btn btn-danger"><span class="glyphicon glyphicon-minus"></span> 删除12</button>
		</div>
	</div>
	...
	<div id="remarkBody" style="position: relative; top: 10px; left: 40px;">
		...
		<!-- 备注1 -->
		<%--<div id="remarkDiv" style="height: 60px;">
		...
		<div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
			<form role="form" style="position: relative;top: 10px; left: 10px;">
				...
				<p id="cancelAndSaveBtn" style="position: relative;left: 737px; top: 10px; display: none;">
					...
					<button type="button" id="saveRemarkBtn" class="btn btn-primary">保存1</button>
				</p>
			</form>
		</div>
	</div>
	...
	<div>
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div>
				<a onclick="window.location.href='workbench/transaction/add.do'" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>新建交易</a>
			</div>
		</div>
	</div>
